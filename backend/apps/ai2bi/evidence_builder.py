...
def save_evidence_record(
    ...
    topic_contract: dict | None = None,
    topic_plan: dict | None = None,
    topic_bp_output: dict | None = None,
    topic_queries: list | None = None,
    ...
    common = dict(  # noqa: C408
        ...
        analysis_intent=json.dumps(analysis_intent, ensure_ascii=False, default=str) if analysis_intent else None,
        topic_contract=json.dumps(topic_contract, ensure_ascii=False, default=str) if topic_contract else None,
        topic_plan=json.dumps(topic_plan, ensure_ascii=False, default=str) if topic_plan else None,
        topic_bp_output=json.dumps(topic_bp_output, ensure_ascii=False, default=str) if topic_bp_output else None,
        topic_queries=json.dumps(topic_queries or [], ensure_ascii=False, default=str) if topic_queries else None,
